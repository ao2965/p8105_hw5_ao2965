...
equal to the true μ, especially for small effect sizes. 

For μ = 0, the average estimate among rejected samples is ~0.4 (not 0), showing 
substantial upward bias. This bias decreases as μ increases, nearly disappearing 
by μ = 5-6.

This occurs because when the true effect is small, we only reject the null when 
random variation produces unusually large estimates. This selection bias disappears 
